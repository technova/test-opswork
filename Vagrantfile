...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "sonirajesh-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/technova_"
  #   chef.validation_client_name = "technova_-validator"
  #   chef.validation_key_path = ".chef/technova_-validator.pem"
  # end
end
